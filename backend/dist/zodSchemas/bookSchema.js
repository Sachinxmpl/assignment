...
exports.bookSchema = zod_1.z.object({
    ...
    categoryId: zod_1.z.number().int().positive('Valid category ID is required'),
    totalCopies: zod_1.z.number().int().min(1, 'At least one copy is required'),
});
exports.updateBookSchema = zod_1.z.object({
    ...
    categoryId: zod_1.z.number().int().positive('Valid category ID is required').optional(),
    totalCopies: zod_1.z.number().int().min(1, 'At least one copy is required').optional(),
});
